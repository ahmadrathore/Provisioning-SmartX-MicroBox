...
public class get_ping_latency_aggregate  extends TimerTask {
	...
	public int count_oneday_ping_SmartX_Box=0, count_oneday_ping_SmartX_Box_PH=0, count_oneday_ping_SmartX_Box_HUST=0, count_oneday_ping_SmartX_Box_CHULA=0, 
		...
		// TODO Auto-generated method stub
				...
				System.out.println(today_now.getTime());
			       ...
			       /* for (Document document : documents) 
			        ...
			        {
			        uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_PH=(float) Box_PH_ping/(count_oneday_ping_SmartX_Box)*100;
			        ...
			        uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_CHULA=(float) Box_CHULA_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_MYREN=(float) Box_MYREN_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_GIST3=(float) Box_GIST3_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_GIST0=(float) Box_GIST0_ping/(count_oneday_ping_SmartX_Box)*100;
				    ...
				    out.println(simpleDateFormatNoZone.format(timestamp)+" "+document_pingscore.getString("SmartX-Box-SOURCE")+" "+"-"+ " "+uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_PH+ " "+uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_HUST + " "+uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_CHULA + " "+uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_MYREN + " "+uptime_oneday_ping_SmartX_Box_GIST1_dest_Box_GIST3);
						//more code
			        ...
			        if(count_oneday_ping_SmartX_Box>0) 
			        {
			        uptime_oneday_ping_SmartX_Box_PH_dest_Box_GIST1=(float) Box_GIST1_ping/(count_oneday_ping_SmartX_Box)*100;
			        //float uptime_oneday_ping_SmartX_Box_PH_dest_Box_PH= (Box_PH_ping/count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_PH_dest_Box_HUST=(float) Box_HUST_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_PH_dest_Box_CHULA=(float) Box_CHULA_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_PH_dest_Box_MYREN=(float) Box_MYREN_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_PH_dest_Box_GIST3=(float) Box_GIST3_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_PH_dest_Box_GIST0=(float) Box_GIST0_ping/(count_oneday_ping_SmartX_Box)*100;
			        System.out.println("Printing count_oneday_ping_SmartX_Box, uptime, Downtime" );
					...
					mongoConnector.getDbConnection().getCollection(topologyMongoCollection_ping_aggregate).insertOne(document_pingscore);
					out.println(simpleDateFormatNoZone.format(timestamp)+" "+document_pingscore.getString("SmartX-Box-SOURCE")+" "+uptime_oneday_ping_SmartX_Box_PH_dest_Box_GIST1+ " "+"-"+ " "+uptime_oneday_ping_SmartX_Box_PH_dest_Box_HUST + " "+uptime_oneday_ping_SmartX_Box_PH_dest_Box_CHULA + " "+uptime_oneday_ping_SmartX_Box_PH_dest_Box_MYREN + " "+uptime_oneday_ping_SmartX_Box_PH_dest_Box_GIST3);
					document_pingscore.clear();
			        reset_values();
			        ...
			        if(count_oneday_ping_SmartX_Box>0) 
			        {
			        uptime_oneday_ping_SmartX_Box_HUST_dest_Box_GIST1=(float) Box_GIST1_ping/(count_oneday_ping_SmartX_Box)*100;
			        ...
			        uptime_oneday_ping_SmartX_Box_HUST_dest_Box_PH=(float) Box_PH_ping/(count_oneday_ping_SmartX_Box)*100;
			        ...
			        uptime_oneday_ping_SmartX_Box_HUST_dest_Box_CHULA=(float) Box_CHULA_ping/(count_oneday_ping_SmartX_Box)*100;
			        ...
			        uptime_oneday_ping_SmartX_Box_HUST_dest_Box_MYREN=(float) Box_MYREN_ping/(count_oneday_ping_SmartX_Box)*100;
			        ...
			        uptime_oneday_ping_SmartX_Box_HUST_dest_Box_GIST3=(float) Box_GIST3_ping/(count_oneday_ping_SmartX_Box)*100;
			        ...
			        uptime_oneday_ping_SmartX_Box_HUST_dest_Box_GIST0=(float) Box_GIST0_ping/(count_oneday_ping_SmartX_Box)*100;
					...
					mongoConnector.getDbConnection().getCollection(topologyMongoCollection_ping_aggregate).insertOne(document_pingscore);
					out.println(simpleDateFormatNoZone.format(timestamp)+" "+document_pingscore.getString("SmartX-Box-SOURCE")+" "+uptime_oneday_ping_SmartX_Box_HUST_dest_Box_GIST1+ " "+uptime_oneday_ping_SmartX_Box_HUST_dest_Box_PH + " "+"-"+ " "+uptime_oneday_ping_SmartX_Box_HUST_dest_Box_CHULA + " "+uptime_oneday_ping_SmartX_Box_HUST_dest_Box_MYREN + " "+uptime_oneday_ping_SmartX_Box_HUST_dest_Box_GIST3);
					document_pingscore.clear();
			        reset_values();
			        ...
			        if(count_oneday_ping_SmartX_Box>0) 
			        {
			       	uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_GIST1=(float) Box_GIST1_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_PH=(float) Box_PH_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_HUST= Box_HUST_ping/(count_oneday_ping_SmartX_Box)*100;
			        //float uptime_oneday_ping_SmartX_BoxCHULA_dest_Box_CHULA=(float) Box_CHULA_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_MYREN=(float) Box_MYREN_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_GIST3=(float) Box_GIST3_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_GIST0=(float) Box_GIST0_ping/(count_oneday_ping_SmartX_Box)*100;
			        System.out.println("Printing count_oneday_ping_SmartX_Box, uptime, Downtime" );
					...
					mongoConnector.getDbConnection().getCollection(topologyMongoCollection_ping_aggregate).insertOne(document_pingscore);
					out.println(simpleDateFormatNoZone.format(timestamp)+" "+document_pingscore.getString("SmartX-Box-SOURCE")+" "+uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_GIST1+ " "+uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_PH +" "+uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_HUST+ " "+"-"+ " "+uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_MYREN + " "+uptime_oneday_ping_SmartX_Box_CHULA_dest_Box_GIST3);
					document_pingscore.clear();
			        reset_values();
			        ...
			        if(count_oneday_ping_SmartX_Box>0) 
			        {
			       	uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_GIST1=(float) Box_GIST1_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_PH=(float) Box_PH_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_HUST= Box_HUST_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_CHULA=(float) Box_CHULA_ping/(count_oneday_ping_SmartX_Box)*100;
			        //float uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_MYREN=(float) Box_MYREN_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_GIST3=(float) Box_GIST3_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_GIST0=(float) Box_GIST0_ping/(count_oneday_ping_SmartX_Box)*100;
			        System.out.println("Printing count_oneday_ping_SmartX_Box, uptime, Downtime" );
					...
					mongoConnector.getDbConnection().getCollection(topologyMongoCollection_ping_aggregate).insertOne(document_pingscore);
					out.println(simpleDateFormatNoZone.format(timestamp)+" "+document_pingscore.getString("SmartX-Box-SOURCE")+" "+uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_GIST1+ " "+uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_PH + " "+uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_HUST + " "+uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_CHULA+" "+"-"+ " "+uptime_oneday_ping_SmartX_Box_MYREN_dest_Box_GIST3);
					document_pingscore.clear();
			        reset_values();
			        ...
			        if(count_oneday_ping_SmartX_Box>0) 
			        {
			       	uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_GIST1=(float) Box_GIST1_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_PH=(float) Box_PH_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_HUST= Box_HUST_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_CHULA=(float) Box_CHULA_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_MYREN=(float) Box_MYREN_ping/(count_oneday_ping_SmartX_Box)*100;
			        //float uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_GIST3=(float) Box_GIST3_ping/(count_oneday_ping_SmartX_Box)*100;
			        uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_GIST0=(float) Box_GIST0_ping/(count_oneday_ping_SmartX_Box)*100;
			        System.out.println("Printing count_oneday_ping_SmartX_Box, uptime, Downtime" );
					...
					mongoConnector.getDbConnection().getCollection(topologyMongoCollection_ping_aggregate).insertOne(document_pingscore);
					out.println(simpleDateFormatNoZone.format(timestamp)+" "+document_pingscore.getString("SmartX-Box-SOURCE")+" "+uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_GIST1+ " "+uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_PH + " "+uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_HUST +" "+uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_CHULA+ " "+uptime_oneday_ping_SmartX_Box_GIST3_dest_Box_MYREN + " "+"-");
